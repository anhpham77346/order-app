    ...
    return (
        <div className="bg-[#1C2434] flex flex-col w-[250px] h-screen text-white p-4">
            ...
            <div className="mt-10 flex-1">
                <div onClick={goToMenu} className={`cursor-pointer flex gap-4 items-center px-6 py-3 rounded-md ${location.pathname === routes.menu || location.pathname === routes.home ? 'bg-slate-700' : 'hover:bg-slate-700'}`}>
                    <div>
